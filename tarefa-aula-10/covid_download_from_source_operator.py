...
class CovidDownloadFromSourceOperator(BaseOperator):
    ...
    def download_file(self):
        ...
        chunksize = 10 ** 6
        df = pd.read_csv(tar_path, header=0, nrows=2000000) # Aqui existe um limitador para evitar utilizar recurso de memoria da máquina do aluno, reduzir esse valor caso o aluno tenha problemas
        csv_buffer = StringIO()
